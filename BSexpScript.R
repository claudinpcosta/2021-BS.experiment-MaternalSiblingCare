...
Snull <- glmer(Survival.hours ~1 + (1 | ColonyID_queen) + (1 | QueenID) + (1 | Behavioral.assay), data=survival, family=Gamma(link="log"))
S1 <- glmer(Survival.hours ~ Treatment + (1 | ColonyID_queen) + (1 | QueenID) + (1 | Behavioral.assay), data=survival, family=Gamma(link="log"))
S2 <- glmer(Survival.hours ~ Avg.mm + (1 | ColonyID_queen) + (1 | QueenID) + (1 | Behavioral.assay), data=survival, family=Gamma(link="log"))
S3 <- glmer(Survival.hours ~ Time.development.days + (1 | ColonyID_queen) + (1 | QueenID) + (1 | Behavioral.assay), data=survival, Gamma(link="log"))
S4 <- glmer(Survival.hours ~ Treatment + Avg.mm + Time.development.days + (1 | ColonyID_queen) + (1 | QueenID) + (1 | Behavioral.assay), data=survival, family=Gamma(link="log"))
S5 <- glmer(Survival.hours ~ Treatment + Avg.mm * Time.development.days + (1 | ColonyID_queen) + (1 | QueenID) + (1 | Behavioral.assay), data=survival, family=Gamma(link="log"))
S6 <- glmer(Survival.hours ~ Treatment + Avg.mm + (1 | ColonyID_queen) + (1 | QueenID) + (1 | Behavioral.assay), data=survival, family=Gamma(link="log"))
S7 <- glmer(Survival.hours ~ Treatment + Time.development.days + (1 | ColonyID_queen) + (1 | QueenID) + (1 | Behavioral.assay), data=survival, family=Gamma(link="log"))
S8 <- glmer(Survival.hours ~ Avg.mm + Time.development.days + (1 | ColonyID_queen) + (1 | QueenID) + (1 | Behavioral.assay), data=survival, family=Gamma(link="log"))
S9 <- glmer(Survival.hours ~ Avg.mm * Time.development.days + (1 | ColonyID_queen) + (1 | QueenID) + (1 | Behavioral.assay), data=survival, family=Gamma(link="log"))
S10 <- glmer(Survival.hours ~ Treatment + Avg.mm + Time.development.days + Avg.mm * Time.development.days + (1 | ColonyID_queen) + (1 | QueenID) + (1 | Behavioral.assay), data=survival, family=Gamma(link="log"))
S11 <- glmer(Survival.hours ~ Treatment + Avg.mm + Time.development.days + Avg.mm * Time.development.days + Avg.mm * Time.development.days * Treatment + (1 | ColonyID_queen) + (1 | QueenID) + (1 | Behavioral.assay), data=survival, family=Gamma(link="log"))
S12 <- glmer(Survival.hours ~ Avg.mm * Time.development.days * Treatment + (1 | ColonyID_queen) + (1 | QueenID) + (1 | Behavioral.assay), data=survival, family=Gamma(link="log"))
S13 <- glmer(Survival.hours ~ Time.development.days + Avg.mm * Time.development.days * Treatment + (1 | ColonyID_queen) + (1 | QueenID) + (1 | Behavioral.assay), data=survival, family=Gamma(link="log"))
S14 <- glmer(Survival.hours ~ Treatment + Avg.mm + Time.development.days + Avg.mm * Time.development.days * Treatment + (1 | ColonyID_queen) + (1 | QueenID) + (1 | Behavioral.assay), data=survival, family=Gamma(link="log"))
S15 <- glmer(Survival.hours ~ Treatment + Avg.mm * Time.development.days + Avg.mm * Time.development.days * Treatment + (1 | ColonyID_queen) + (1 | QueenID) + (1 | Behavioral.assay), data=survival, family=Gamma(link="log"))
S16 <- glmer(Survival.hours ~ Treatment + Avg.mm + Avg.mm * Time.development.days * Treatment + (1 | ColonyID_queen) + (1 | QueenID) + (1 | Behavioral.assay), data=survival, family=Gamma(link="log"))
S17 <- glmer(Survival.hours ~ Treatment + Time.development.days + Avg.mm * Time.development.days * Treatment + (1 | ColonyID_queen) + (1 | QueenID) + (1 | Behavioral.assay), data=survival, family=Gamma(link="log"))
S18 <- glmer(Survival.hours ~ Avg.mm + Time.development.days + Avg.mm * Time.development.days * Treatment + (1 | ColonyID_queen) + (1 | QueenID) + (1 | Behavioral.assay), data=survival, family=Gamma(link="log"))
S19 <- glmer(Survival.hours ~ Avg.mm * Time.development.days + Avg.mm * Time.development.days * Treatment + (1 | ColonyID_queen) + (1 | QueenID)+ (1 | Behavioral.assay), data=survival, family=Gamma(link="log"))
